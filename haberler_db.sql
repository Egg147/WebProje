...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 02 Haz 2024, 19:31:56
...
--
CREATE DATABASE IF NOT EXISTS `haberler_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `haberler_db`;
...
--
-- Tablo döküm verisi `haber_tablo`
--

INSERT INTO `haber_tablo` (`haber_id`, `kategori_id`, `haber_baslik`, `haber_icerik`, `yazar_id`, `haber_tarih`) VALUES
(28, 4, 'asfaw', '      awdaf  ', 4, '2024-06-02 19:50:10');
...
--
ALTER TABLE `haber_tablo`
  MODIFY `haber_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
('root', '[{\"db\":\"haberler_db\",\"table\":\"haber_tablo\"},{\"db\":\"haberler_db\",\"table\":\"kategori_tablo\"},{\"db\":\"haberler_db\",\"table\":\"yazar_tablo\"},{\"db\":\"proje\",\"table\":\"uyeler\"},{\"db\":\"proje\",\"table\":\"mesajlar\"}]');
...
('root', '2024-06-02 17:31:29', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"tr\"}');
